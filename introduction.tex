...
With the extension to a third dimension the environment should offer fewer ambiguous locations than two dimensional ones, since there are more features to detect and to be compared with the map. %This should lead to a faster convergence towards the real pose of the robot. 
\todo[inline]{find out and change accordingly}
