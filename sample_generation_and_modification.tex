...
One important part of the algorithm is sampling\index{sampling}. Not only the sampling of new poses is crucial, it is also important that the noise in the motion model is sampled correctly. 
