...
It can also be seen in \tableRef{tab:rtspeedrestable}, that smaller numbers of vertices and faces improve the time needed for the ray tracing. Using the mesh optimization software of the \gls{lvr} can thus lead to better results.
